  ...
  render() {
    ...
    return (
      <div>
        ...
        <Row>
          <Col span={21}><b>Availability </b><Tooltip title="Availability"><Icon type="info-circle"
                                                                                 theme="outlined"/></Tooltip></Col>
          <Col span={3} style={{float: 'right'}}><a onClick={this.clearAvailabilitySelected}>Clear</a></Col>
        </Row>
        <Row>
          <Col span={24}>
            <CheckboxGroup options={availability} value={availabilitySelected} style={{width: 200}}
                           onChange={this.onAvailChkGrpChange}/>
          </Col>
        </Row><br/><br/>
        <Row>
